...
<script type="text/javascript"
	src="/spring-mvc-dwr/krams/dwr/interface/dwrService.js"></script>
...
<body>
	...
	<div style="border: 1px solid #ccc; width: 250px;">
		Add Two Numbers: <input id="inputNumber1" type="text" size="5">
		+ <input id="inputNumber2" type="text" size="5"> <input
			type="submit" value="Add" onclick="add()" /> Sum: <span id="sum">(Result
